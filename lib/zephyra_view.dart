...
class _ZephyraViewState extends State<ZephyraView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: Stack(children: [
      Positioned.fill(
          child: Image.asset('resources/images/bg_forest_green.webp',
              fit: BoxFit.cover)),
      ClipRRect(
      ...
      Align(
          ...
          child: Transform(
              ...
              child: OverflowBox(
                  maxHeight: 2000,
                  maxWidth: 2000,
                  child: Image.asset('resources/images/zephyra.png',
                          height: maxH * 0.85, fit: BoxFit.contain)
                      .animate()
                      .fadeIn(
                          delay: 300.ms,
                          duration: 1000.ms,
